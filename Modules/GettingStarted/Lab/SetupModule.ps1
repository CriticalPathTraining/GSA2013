...
$siteDomain = "ted.wingtip.com"
$siteUrl = "http://$siteDomain"
$siteDisplayName = "Ted Site Collection"
$siteTemplate = "STS#0"
...
$site = New-SPSite -URL $siteUrl -Name $siteDisplayName -Template $siteTemplate `
                   -OwnerAlias $siteOwner -HostHeaderWebApplication $hostWebApplication
